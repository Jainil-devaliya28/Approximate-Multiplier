...
HD_PWD='C:/Users/Dell/Downloads/Log_Mulitplier/Log_Mulitplier/Log_Mulitplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Log_Multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Log_Multiplier.tcl
