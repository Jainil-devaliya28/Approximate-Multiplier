...
HD_PWD='C:/Users/Dell/Downloads/Log_Mulitplier/Log_Mulitplier/Log_Mulitplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Log_Multiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Log_Multiplier.tcl -notrace
